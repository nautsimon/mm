var days = [
  {
    ...
    miles: 338,
    text:
      "We started the day at the Econolodge in Renton, WA. We grabbed Starbucks for breakfast and waited for Lisa to return with Ran (she had been kindly cleaning him all morning). We then dropped her off and headed to Walmart to stock up on snacks for the trip. Confident that I (Lucy) had mastered the stick, I took the first driving shift. About five minutes later, I stalled on the entrance to the freeway, panicked, and Simon took over. Luckily, I would have the next two weeks to practice. With me safely in the passenger seat and a power inverter secured from Home Depot, we started our drive to Portland around 5:30pm. It was a short but beautiful drive through several small towns and across a few cool bridges. It was dark by the time we got to Portland, but we had an awesome view of a lit-up downtown from across the water. We stopped for gas, and were confused when somebody came up to our window until we remembered that gas station attendants exist in Oregon. We grabbed Olive Garden for dinner, watching Zootopia on my phone while we ate in Ran. Feeling revitalized by food, we decided to drive another hour or so to the campground that we had chosen. When we arrived, though, the campground was full. As were all the campgrounds after that. We realized that we had greatly underestimated the Oregonians and their affinity for camping, especially when they had nothing else to do (@COVID). We ended up stopping at a viewpoint where a couple of people were already sleeping. The stars were incredible, and we could hear the waves crashing on the beach below. We leaned the front seats all the way back, and we fell asleep quickly.",
  },
  {
    day: "day_2",
    date: "07/25/20",
  ...
  },
  {
    ...
    ogUrl: [],
    date: "07/28/20",
    location: "Las Vegas to Salt Lake City ",
    miles: 442,
    captions: [
      "the road",
      "artsy",
  ...
  },
  {
    ...
    ogUrl: [],
    date: "07/29/20",
    location: "Salt Lake City to Yellowstone ",
    miles: 348,
    captions: [
  ...
  },
  {
    ...
    ogUrl: [],
    date: "07/30/20",
    location: "Yellowstone to Gillette",
    miles: 477,
    captions: [
      "what a view",
      "bison",
  ...
  },
  {
    ...
    ogUrl: [],
    date: "07/31/20",
    location: "Gillette to Sioux Falls",
    miles: 572,
  ...
  },
  {
    ...
    ogUrl: [],
    date: "08/01/20",
    location: "Sioux Falls to Arlington Heights",
    miles: 562,
  ...
  },
  {
    ...
    ogUrl: [],
    date: "08/02/20",
    location: "Arlington Heights to Germantown",
    miles: 761,
    captions: [
      "road",
      "chicago",
...

  {
    ...
    ogUrl: [],
    date: "08/13/20",
    location: "Frederick to Orient Point",
    miles: 347,
    captions: [
      "bridge",
      "city",
  ...
  },
  {
    ...
    ogUrl: [],
    date: "08/14/20",
    location: "Orient Point to South Portland",
    miles: 222,
    captions: [
      "the ferry",
      "tired",
  ...
  },
  {
    ...
    date: "08/16/20",
    location: "Warners Travel Plaza to Frederick",
    miles: 626,
    text:
