var days = [
  {
    ...
    date: "06/16/19",
    location: "Matanuska Glacier Veiwpoint to Anchorage",
    miles: 118,
    money: 25,
    text:
      "Woke up early at 5 then went back to sleep and woke up at 630. Zoe called me and then I started biking. Most of today was a descent featuring some of the most beautiful scenery of the entire trip. I ran into a homeless women walking barefoot on the side of the highway. Her name was Sandra I think. Didn’t really take too many stops besides at Palmer, which marked the last 40 miles of my transcontinental trek. At Palmer I stopped at a McDonalds located next to a Carrs and a Fred Meyer. Got some super strong Alaskan vibes from that. After chillin in McDonald’s for a bit I got my stuff together and began the final 40 miles into anchorage. I biked fast, reminiscing on the past two months and all the amazing experiences and people I was able to meet. I don’t think I’ve ever felt more alive and real. Once I got into the anchorage city limits I put on my victory playlist that I curated over the trip and cruised through the hometown to taco king. I met up with my homie zacks family and we munched. For the rest of the evening we drove around and met up with a bunch of the boys. It was honestly surreal. Like I had really just finished biking across North America. I went to bed that night dreaming about tacos and the boys - The ambitious adventure was over."
  },
  {
    day: "day_72",
    col: [[], [], []],
    ...
    date: "06/15/19",
    location: "Gakona to Mantushka Glacier Viewpoint",
    miles: 118,
    money: 25,
    text:
      "Woke up at 7. Slept really well but not enough. Ate the rest of my oatmeal and headed out. Stopped at Glennallen for water. Some madman landed his plane on the highway, taxied to the gas station fueled up, then took off from the highway. Biked fast. Lots of elevation but the headwind was not as bad as yesterday. Watched the punisher movie which was kinda annoying. The really long fight scene with opera music in the background was cringey. Stopped at the eureka roadhouse per recommendation from tok guy. They have 25 cent coffee and the best cinnamon buns in the entire world holy shit. Shredded some serious hills. Did some drone flying. Arrived to the glacier view point I wanted to stop at. Sleeping under an overhang. Called my dad for fathers day since hes 17 hours ahead. Staring out into the valley and the glacier from my sleeping bag for awhile. I reflected on my trip so far."
  },
  {
    day: "day_71",
    col: [[], [], []],
    popUrl: [],
    ogUrl: [],
    captions: ["rail", "host heading off", "rail", "water", "mountain"],
    date: "06/14/19",
    location: "Tok to Gakona",
    miles: 121,
    money: 0,
    text:
      "Day started off good. Ate a ton of sourdough toast and a huge breakfast. Host and I shared stories for awhile and lost track of time. One of his friends also stopped by. Ended up leaving at 11. Host is going on a motorcycle journey of his own to Haines. The rest of the day sucked so much ass. The strongest consistent headwind I’ve ever had blasted me without failure the whole day. It slowed me so much I arrived to Gakona at 1am. As the miles droned on, my knees started to hurt more and more. It rained a bit too. Then I fucking ran out of water. I got so dehydrated that both of my nostrils started bleeding. I got blood everywhere. I kept going tho, ended stopping at chistontina at a creek and said fuck it and drank creek water. Ate the rest of the rotisserie chicken that host gave me and that I stored in a ziplock. As I left Chistotina I stopped at this rv park and ended up getting free water. Talked to some people baking s’mores for awhile and then completed the last 39 miles. Saw a grizzly but he retreated. Upon arrival to Gakona I went into a bar and got three cups of coke for free. Got some granola bars on the house too. Watched like the first half of the hulk movie on the bar's screen then opened my sleeping bag on the ground behind the bar's kitchen and fell asleep."
  },
  {
    day: "day_70",
    col: [[], [], []],
    popUrl: [],
    ogUrl: [],
    captions: ["the bus", "where I slept"],
    date: "06/13/19",
    location: "Tok",
    miles: 0,
    money: 4,
    text:
      "Went and got my thumb finally fixed, so much pus came out. Worked on scholarship applications and hung out with my host. Ate a whole chicken. Spent the day updating the website and applying to pre-orientation programs at uchicago. Went to bed at 3am after cranking out 5 applications."
  },
  {
    day: "day_69",
    col: [[], [], []],
